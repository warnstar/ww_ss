...
<div class="banner">
  <div class="user-box">
    ...
    <div class="user-login">
      ...
      <form id="login_form" action="../../home/index.php?act=login" method="post">
        ...
        <dl>
          ...
          <dd>
            ...
            <img src="../../home/index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
        <dl>
          ...
          <dd>
            ...
            <a href="../../home/index.php?act=login&op=forget_password" target="_blank"><?php echo $lang['login_index_forget_password'];?></a></dd>
        </dl>
      </form>
      <div class="register">还没有成为我们的合作伙伴？ <a href="../../home/index.php?act=login&op=register" target="_blank">快速注册</a></div>
    </div>
    <?php } ?>
  </div>
