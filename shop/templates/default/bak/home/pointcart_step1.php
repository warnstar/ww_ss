...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <form method="post" id="porder_form" name="porder_form" action="../../home/index.php?act=pointcart&op=step2">
      <div class="ncc-receipt-info">
        <div class="ncc-receipt-info-title">
          <h3><?php echo $lang['pointcart_step1_receiver_address'];?><a href="../../home/index.php?act=member_address&op=address" target="_blank">[管理]</a></h3>
        </div>
        <!-- 已经存在的收获地址start -->        
      ...
      <div class="ncc-bottom">
        <a href="../../home/index.php?act=pointcart" class="ncc-btn"><?php echo $lang['pointcart_step1_return_list'];?></a>
