...
<div class="ncp-member-point">
  <dl style="border-left: none 0;">
    <a href="../../home/index.php?act=member_points" target="_blank">
  ...
  <dl>
    <a href="../../home/index.php?act=member_voucher&op=index" target="_blank">
  ...
  <dl>
    <a href="../../home/index.php?act=member_pointorder&op=orderlist" target="_blank">
...
<?php if (C('pointprod_isuse')==1){?>
<div class="ncp-memeber-pointcart"> <a href="../../home/index.php?act=pointcart" class="btn">礼品兑换购物车<?php if ($output['pointcart_count'] > 0){?><em><?php echo $output['pointcart_count']; ?></em><?php } ?></a></div>
<?php }?>
