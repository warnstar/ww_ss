  ...
  <div class="ncc-main">
    <div class="ncc-title">
      ...
      <div class="ncc-receipt-info mb30">
        ...
        <a class="ncc-btn-mini ncc-btn-acidblue" href="../../home/index.php?act=member_pointorder&op=order_info&order_id=<?php echo $output['order_info']['point_orderid'];?>"><i class="icon-file-text-alt"></i><?php echo $lang['pointcart_step2_view_order'];?></a></div>
      </div>
  </div>
</div>
