  ...
  <div class="content">
    <ul>
      <li>
        ...
        <div class="cat_list">
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['shuma']['fc_index_id1']?>"><?php echo $output['shuma']['fc_index_name1'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['shuma']['fc_index_id2']?>"><?php echo $output['shuma']['fc_index_name2'];?></a></p>
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['shuma']['fc_index_id3']?>"><?php echo $output['shuma']['fc_index_name3'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['shuma']['fc_index_id4']?>"><?php echo $output['shuma']['fc_index_name4'];?></a></p>
        </div>
      </li>
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/flea/cat2.gif" /></div>
        <div class="cat_list">
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['zhuangban']['fc_index_id1']?>"><?php echo $output['zhuangban']['fc_index_name1'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['zhuangban']['fc_index_id2']?>"><?php echo $output['zhuangban']['fc_index_name2'];?></a></p>
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['zhuangban']['fc_index_id3']?>"><?php echo $output['zhuangban']['fc_index_name3'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['zhuangban']['fc_index_id4']?>"><?php echo $output['zhuangban']['fc_index_name4'];?></a></p>
        </div>
      </li>
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/flea/cat3.gif" /></div>
        <div class="cat_list">
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['jujia']['fc_index_id1']?>"><?php echo $output['jujia']['fc_index_name1'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['jujia']['fc_index_id2']?>"><?php echo $output['jujia']['fc_index_name2'];?></a></p>
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['jujia']['fc_index_id3']?>"><?php echo $output['jujia']['fc_index_name3'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['jujia']['fc_index_id4']?>"><?php echo $output['jujia']['fc_index_name4'];?></a></p>
        </div>
      </li>
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/flea/cat4.gif" /></div>
        <div class="cat_list">
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['xingqu']['fc_index_id1']?>"><?php echo $output['xingqu']['fc_index_name1'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['xingqu']['fc_index_id2']?>"><?php echo $output['xingqu']['fc_index_name2'];?></a></p>
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['xingqu']['fc_index_id3']?>"><?php echo $output['xingqu']['fc_index_name3'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['xingqu']['fc_index_id4']?>"><?php echo $output['xingqu']['fc_index_name4'];?></a></p>
        </div>
      </li>
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/flea/cat5.gif" /></div>
        <div class="cat_list">
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['muying']['fc_index_id1']?>"><?php echo $output['muying']['fc_index_name1'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['muying']['fc_index_id2']?>"><?php echo $output['muying']['fc_index_name2'];?></a></p>
          <p><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['muying']['fc_index_id3']?>"><?php echo $output['muying']['fc_index_name3'];?></a><a target="_blank" href="../../home/index.php?act=flea_class&cate_input=<?php echo $output['muying']['fc_index_id4']?>"><?php echo $output['muying']['fc_index_name4'];?></a></p>
        </div>
      </li>
    </ul>
  </div>
...
<div id="KinSlideshow" style="visibility:hidden;">
      ...
      <div class="hotgoods">
        <h2><a class="more gray2 fn-right" href="../../home/index.php?act=flea_class"><?php echo $lang['flea_goods_more'];?></a></h2>
      ...
      <div class="sell">
              ...
              <div class="collect_goods">
                ...
                <div class="pic fn-left">
                  <span class="thumb size76">
                    <i></i>
                    <a title="<?php echo $output['col_flea_goods']['goods_name'];?>" href="../../home/index.php?act=flea_goods&goods_id=<?php echo $output['col_flea_goods']['goods_id']?>" target="_blank"><img height="76" width="76" onload="javascript:DrawImage(this,76,76);" src="<?php echo $output['col_flea_goods']['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['col_flea_goods']['member_id'].DS.$output['col_flea_goods']['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>" /></a>
                  </span>
                </div>
                <div class="collect_info fn-left">
                  <p class="details"><a class="blue2" target="_blank" href="../../home/index.php?act=flea_goods&goods_id=<?php echo $output['col_flea_goods']['goods_id']?>"><?php echo $output['col_flea_goods']['goods_name']?></a></p>
        ...
        <div id="buttonContainer"><a href="../../home/index.php?act=member_flea&op=add_goods" class="button big blue"></a></div>
      </div>
  </div>
  <div id="fir_items" class="fn-left">
    <h2><a href="../../home/index.php?act=flea_class" class="gray2"><?php echo $lang['flea_more_hot_goods'];?></a></h2>
    <ul>
      ...
      <li<?php if($i==7||$i==14){echo ' class="cn"';}?>>
        <div class="pic">
          <span class="thumb size120">
            <i></i>
            <a target="_blank" title="<?php echo $val['goods_name']; ?>" href="../../home/index.php?act=flea_goods&goods_id=<?php echo $val['goods_id']?>"><img height="120" width="120" onload="javascript:DrawImage(this,120,120);" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>" /></a>
          </span>
        </div>
  ...
  <div id="third_items" class="fn-left">
    <h2><a class="gray2" href="../../home/index.php?act=flea_class"><?php echo $lang['flea_more_flea_goods'];?></a></h2>
    <div class="content">
      <ul class="look_items">
        ...
        <li class="fn-left">
          <div class="pic">
            <span class="thumb size125">
              <i></i>
              <a target="_blank" title="<?php echo $val['goods_name']?>" href="../../home/index.php?act=flea_goods&goods_id=<?php echo $val['goods_id']?>"><img height="125" width="125" onload="javascript:DrawImage(this,125,125);" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>" /></a>
            </span>
          </div>
