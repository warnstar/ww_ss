      ...
      <ul id="slider_high">
        ...
        <?php if(!empty($output['goods_commend']) && is_array($output['goods_commend'])){?>
            ...
            <span class="thumb size76">
              <i></i>
              <a href="../../home/index.php?act=flea_goods&type=goods&goods_id=<?php echo $comment_goods['goods_id'];?>">
   ...
   <span><a href="#" class="blue" onclick="javascrit:collect_flea(<?php echo $output['goods']['goods_id'];?>);return false;"><?php echo $lang['flea_goods_collect_goods'];?></a></span>    </div>  
      ...
      <div class="ware_info">
        ...
        <ul class="item_info">
          ...
          <li><em><?php echo $lang['flea_transfer_area'];?>:</em><a class="orange" href="../../home/index.php?act=flea_class&area_input=<?php echo $output['goods']['flea_area_id']?>"><?php echo $output['goods']['flea_area_name']?></a></li>
          <li class="rank_new">
		  ...
		  ?>
          <a class="blue" href="../../home/index.php?act=flea_class&key_input=<?php echo urlencode($val); ?>" target="_blank"><?php echo $val?></a>
          <?php }?>
          <?php }?>
          </li>
        </ul>
    ...
    <div class="col-sub">
      <a href="../../home/index.php?act=member_flea&op=add_goods"></a>
    </div>
    ...
    <div id="seller_info" class="flea_gray mb10">
      ...
      <p><?php echo $lang['flea_store_owner'];?>:<?php echo $output['flea_member_info']['member_name'];?><a href="../../home/index.php?act=member_message&op=sendmsg&member_id=<?php echo $output['flea_member_info']['member_id'];?>" target=_blank><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/web_mail.gif"></a></p>
    </div>
    <div id="seller_info" class="flea_gray mb10">
        ...
        <div class="flea_goods">
           <div class="pic">
             <span class="thumb size60">
               <i></i>
               <a title="<?php echo $val['goods_name']?>" href="../../home/index.php?act=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><img height="60" width="60" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,60,60);"></a>
             </span>
           </div>
           <dl>
             <dt><a href="../../home/index.php?act=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><?php echo $val['goods_name'];?></a></dt>
             <dd><?php echo $lang['currency'];?><a href="../../home/index.php?act=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><?php echo $val['goods_store_price'];?></a></dd>
           </dl>
        </div>
        <?php }?>
        <?php }?>
...
<div id="con_one_3" style="display:none">
    ...
    <li>
      <div class="pic"> 
        <span class="thumb size160">
          <i></i>
          <a title="<?php echo $val3['goods_name'] ?>" href="../../home/index.php?act=flea_goods&type=goods&goods_id=<?php echo $val3['goods_id']?>"><img height="160" width="160" onload="javascript:DrawImage(this,160,160);" src="<?php echo $val3['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val3['member_id'].DS.$val3['goods_image'] : SHOP_TEMPLATES_URL.'/images/member/default_image.png';?>"></a>
        </span>
      </div>
      <h3><a href="../../home/index.php?act=flea_goods&type=goods&goods_id=<?php echo $val3['goods_id']?>"><?php echo $val3['goods_name']?></a></h3>
  ...
  <div id="tb-detail-tips">
    <div id="J_tb-buy-tips" class="tb-buy-tips clearfix">
      ...
      <a href="../../home/index.php?act=member_flea&op=add_goods" class="tb-pub-free" target="_blank"><?php echo $lang['flea_fee_release'];?><i><?php echo $lang['flea_enter_release'];?></i></a>      </div>
</div>
	</div>
  </div>
  <div class="fn-clear"></div>
